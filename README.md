...
This project involves a comprehensive analysis of a pizza restaurant's sales data to identify key business trends. By cleaning the raw data and applying exploratory data analysis (EDA), I uncovered insights regarding peak hours, busy days, and seasonal revenue patterns.

Tech Stack:Python (Pandas for data manipulation)
Jubyter Notebook (Development environment)
